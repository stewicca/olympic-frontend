...
useHead({
  title: metadata.value.data.meta_title ?? category + " | Olympic Furniture",
  meta: [
    { name: "author", content: "Olympic" },
    { name: "description", content: metadata.value.data.meta_desc ?? category },
    { name: "keywords", content: metadata.value.data.keyword ?? "" },
    { name: "robots", content: "all" },
    { property: "og:locale", content: "id" },
    { property: "og:title", content: metadata.value.data.meta_title ?? category + " | Olympic Furniture" },
    { property: "og:description", content: metadata.value.data.meta_desc ?? category },
    { property: "og:type", content: metadata.value.data.seo_type ?? "Website" },
    ...
    { name: "twitter:title", content: metadata.value.data.meta_title ?? category + " | Olympic Furniture" },
    { name: "twitter:description", content: metadata.value.data.meta_desc ?? category },
